...
@section('content')
    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-dark-blue">
                            <div class="card-body">
                                ...
                                <form action="">
                                    <label class="switch">
                                        <input id="sectionON" name="active" onclick="getMessage()" type="checkbox">
        ...
        <footer class="footer">
            ...
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Distributed by <a href="https://www.ewebdevs.com/" target="_blank">ewebdevs</a></span>
            </div>
        </footer>
        <!-- partial -->
    </div>
